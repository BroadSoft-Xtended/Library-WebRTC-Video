...
function Video(eventbus, debug, configuration, sipstack) {
  ...
  var updateClasses = function(){
    self.classes = [
      sipstack.callState,
      configuration.resolutionType || 'standard',
  ...
  self.listeners = function(configurationDatabinder, sipstackDatabinder) {
    ...
    configurationDatabinder.onModelPropChange(['enableSelfView', 'views', 'selfViewLocation', 'selfViewSize', 'resolutionType'], function(){
      updateClasses();
    });
